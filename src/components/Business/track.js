...
const Tracking = ({ onClose }) => {
        ...
        if (button === "collab") {
            return (
                <div style={{ fontSize: "25px", alignItems: "center", display: "flex" }}>
                    <strong style={{ borderRight: "2px solid black", paddingRight: "2rem", marginRight: "2rem" }}>{i}</strong>
                    <strong>{n}</strong>
                </div>
            );
        }
    ...
    const bar1 = (i, n) => {
        return (
            <MDBAccordionItem collapseId={1} headerTitle={bar(i, n)} style={{ backgroundColor: "#002A5C", color: "white", marginBottom: "1rem" }} >
                <div>
                    {button !== "collab" && (<div style={{ display: "flex", justifyContent: "flex-start" }}>
    ...
    return (<>
        ...
        {!showPopup && (
            <div className="container py-3" style={{ height: "100%", width: "100%" }}>
                    ...
                    <MDBCol style={{ height: "100%", display: "flex", flexDirection: "column", flexWrap: "wrap", overflowX: "auto" }}>
                        ...
                        {selectedUser && (
                            <div style={{ height: "92%", display: "flex", flexDirection: "column" }}>
                                <div style={{ backgroundColor: "white", border: "1px solid #ff6f00", borderRadius: "20px", margin: "1rem", padding: "1rem", height: "39%", overflowX: "auto" }}>
                                ...
                                <div style={{ display: "flex", width: "100%", justifyContent: "space-between", height: "7%", overflowX: "auto", flexWrap: "wrap" }} className="px-1">
                                ...
                                {button === "collab" && (
                                    <div style={{ width: "100%" }}>
                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: "space-evenly", margin: '1rem' }}>
                                            <MDBBtn size="md" style={{ backgroundColor: "#FF6F00", justifySelf: "center", opacity: activeButton === 'current' ? 1 : 0.5 }} onClick={() => handleButtonClick('current')}>
                                                Current Collaborations
                                            </MDBBtn>
                                            <MDBBtn size="md" style={{ backgroundColor: "#FF6F00", justifySelf: "center", opacity: activeButton === 'current' ? 0.5 : 1 }} onClick={() => handleButtonClick('previous')}>
                                                Previous Collaborations
                                            </MDBBtn>
                                        </div>
                                    </div>)}
                                <div style={{ display: "flex", flexWrap: "wrap", margin: "1rem", border: "1px solid #ff6f00", borderRadius: '10px', flexDirection: "column", height: "55%" }}>
                                    {button === "review" && (
                                        <div style={{ height: "100%" }}>
                                            <div style={{ display: 'flex', justifyContent: 'space-evenly', color: "#002A5C", width: "100%", margin: "0px", height: "10%" }}>
                                                <h4 style={{ justifySelf: "center", borderRight: "2px solid #002A5C", paddingRight: "2rem" }}>Average Rating</h4>
                                                <div style={{ borderRight: "2px solid #002A5C", paddingRight: "3rem" }}>{stars}</div>
                                    ...
                                    {button === "collab" && (
                                        <div style={{ overflowY: 'scroll', width: "100%", padding: "2rem" }}>
                                            <MDBAccordion alwaysOpen initialActive={0}>
                                                {bar1("LOREAL PARIS--  ", "Beauty and Lifestyle")}
                                                {bar1("LOREAL PARIS--  ", "Beauty and Lifestyle")}
                                                {bar1("Swiss Beauty--  ", "Health And Wellness")}
                                            </MDBAccordion>
                                        </div>
                                    )}
                                    {button === "acheive" && (
