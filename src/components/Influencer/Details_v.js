...
import { MDBBtn, MDBCol, MDBCard, MDBCardBody, MDBCardTitle, MDBCardText, MDBIcon } from "mdb-react-ui-kit";
...
const Details = () => {
  ...
  const handleClick = () => {
    ...
    {/*
    <div>
      {/* <button onClick={handleClick}>Toggle Emojis</button>
      {showEmojis && (
        <div>
  ...
  const handleSidebarButton = (buttonName) => {
    ...
    navigate('/i/details', { state: { parameter: null } });
    // }
    // else
    //{
    //navigate('/profile')
                        ...
                        <MDBCardBody style={{ color: 'white' }}>
                          <div style={{ display: 'flex' }}>
                            ...
                            <div style={{ display: "flex", justifyItems: "right", alignItems: "end" }}>
                              <MDBBtn style={{ backgroundColor: "#FF6F00", height: "2rem", width: "15vw", borderRadius: "50px" }} onClick={handleSubmit}>
                                Apply Now
                              </MDBBtn>
                            </div>
                          </div>
